...
# This is a replication of the result of a paper conducted by Choi and Varian to "nowcast" differnt economic variables from google trends data.   
...
plot_data <- rolling_all %>% 
  select(Period, base,trends,actual) %>% 
