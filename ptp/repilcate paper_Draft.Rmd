...
```{r}
suvs_trends <- read_csv("suvs_2004_2011.csv")
insurance_trends <- read_csv("auto_2004_2011.csv")
# rename
...
```{r}
suvs_trends <- read_csv("suvs_2004_2020.csv")
insurance_trends <- read_csv("auto_2004_2020.csv")
# rename
names1<- names(suvs_trends)
names2 <- names(insurance_trends)
suvs_trends <- suvs_trends %>% 
